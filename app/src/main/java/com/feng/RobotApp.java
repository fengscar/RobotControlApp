...
public class RobotApp extends Application {
    private final static String TAG = RobotApp.class.getSimpleName();
    ...
    public void onCreate() {
        ...
        // 初始化设置
        PreferenceManager.setDefaultValues(context, R.xml.pref_display_settings, false);
        PreferenceManager.setDefaultValues(context, R.xml.pref_robot_settings, false);
        PreferenceManager.setDefaultValues(context, R.xml.pref_sound_settings, false);
//        PreferenceManager.setDefaultValues(context, R.xml.pref_net_settings, false);
